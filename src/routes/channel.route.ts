...
import { createChannel, getWorkspaceChannels, getChannel, joinChannel, addMemberToChannel, updateChannel, softDeleteChannel, hardDeleteChannel, getMentionableUsers } from "../controllers/channel.controller.js";
...
router.get("/:id/mentionable-users", authMiddleware as unknown as RequestHandler, getMentionableUsers as unknown as RequestHandler);
